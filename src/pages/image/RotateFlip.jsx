...
export default function RotateFlip() {
  ...
  const actionButtonClass =
    'focus-ring inline-flex flex-1 items-center justify-center gap-2 rounded-xl border border-slate-200/90 bg-white px-4 py-2.5 text-sm font-medium text-slate-700 shadow-card transition-all hover:border-slate-300 hover:bg-slate-50 active:scale-[0.98] dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300 dark:hover:border-slate-600 dark:hover:bg-slate-800'
        ...
        <div className="space-y-6">
          ...
          <div className="card p-5">
            ...
            <button
              ...
              className="focus-ring mt-3 text-sm font-medium text-slate-500 underline-offset-4 transition-colors hover:text-primary-600 hover:underline dark:text-slate-400"
            >
              Reset
            </button>
          </div>
