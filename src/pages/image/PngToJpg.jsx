...
export default function PngToJpg() {
  ...
  async function convert() {
    ...
    try {
      ...
      const canvas = drawImageToCanvas(img, img.width, img.height, '#ffffff')
    ...
    <ToolPageLayout tool={tool}>
      {!file ? (
        ...
        <div className="space-y-6">
          ...
          {loading && <LoadingState message="Converting to JPG…" />}
          ...
          {result && (
            <ToolResultPanel
              ...
              note="Your JPG image is ready to download."
            />
          )}
        </div>
      )}
